...
import { extractUniqueControls, createControlsLayer } from '../services/courseRenderer'
...
export function ControlsLayer({ map, courses, useProjectedCoords }: ControlsLayerProps) {
  ...
  useEffect(() => {
    ...
    console.log('ControlsLayer effect running with', courses.length, 'courses', 'useProjectedCoords:', useProjectedCoords)
    ...
    const timeoutId = setTimeout(() => {
      ...
      try {
        ...
        const layer = createControlsLayer(uniqueControls, transform)
